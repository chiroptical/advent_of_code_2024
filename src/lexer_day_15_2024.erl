...
-module(lexer_day_15_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 25).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.erl", 339).
yystate() -> 8.

yystate(9, Ics, Line, Col, Tlen, _, _) ->
    {3, Tlen, Ics, Line, Col};
yystate(8, [118 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [94 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [79 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [64 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [62 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [60 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [46 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(8, [35 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 13).
yyaction_0(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {wall, TokenLoc}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 14).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {robot, TokenLoc}}.

-compile({inline, yyaction_2/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 15).
yyaction_2(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {box, TokenLoc}}.

-compile({inline, yyaction_3/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 16).
yyaction_3() ->
    skip_token.

-compile({inline, yyaction_4/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 17).
yyaction_4(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {left, TokenLoc}}.

-compile({inline, yyaction_5/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 18).
yyaction_5(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {right, TokenLoc}}.

-compile({inline, yyaction_6/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 19).
yyaction_6(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {up, TokenLoc}}.

-compile({inline, yyaction_7/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 20).
yyaction_7(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {down, TokenLoc}}.

-compile({inline, yyaction_8/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_15_2024.xrl", 21).
yyaction_8() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
