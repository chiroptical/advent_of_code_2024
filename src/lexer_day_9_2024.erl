...
-module(lexer_day_9_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_9_2024.xrl", 9).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_9_2024.erl", 339).
yystate() -> 0.
...
yyaction(0, TokenLen, YYtcs, _, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_0(TokenChars, TokenCol);
yyaction(_, _, _, _, _) ->
    error.

-compile({inline, yyaction_0/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_9_2024.xrl", 5).
yyaction_0(TokenChars, TokenCol) ->
    {token, {number, TokenCol, list_to_integer(TokenChars)}}.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
    344
).
