...
-module(lexer_day_16_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.xrl", 17).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.erl", 339).
yystate() -> 4.
...
yystate(4, [69 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(4, [46 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.xrl", 9).
yyaction_0(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {wall, TokenLoc}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.xrl", 10).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {start, TokenLoc}}.

-compile({inline, yyaction_2/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.xrl", 11).
yyaction_2(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {stop, TokenLoc}}.

-compile({inline, yyaction_3/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.xrl", 12).
yyaction_3() ->
    skip_token.

-compile({inline, yyaction_4/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_16_2024.xrl", 13).
yyaction_4() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
