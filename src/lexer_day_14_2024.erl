...
-module(lexer_day_14_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 19).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.erl", 339).
yystate() -> 6.

yystate(7, [32 | Ics], Line, Col, Tlen, _, _) ->
    yystate(7, Ics, Line, Col, Tlen + 1, 4, Tlen);
yystate(7, [10 | Ics], Line, _, Tlen, _, _) ->
    yystate(7, Ics, Line + 1, 1, Tlen + 1, 4, Tlen);
yystate(7, Ics, Line, Col, Tlen, _, _) ->
    {4, Tlen, Ics, Line, Col, 7};
yystate(6, [118 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(6, [112 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 10).
yyaction_0(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {position, TokenLoc}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 11).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {velocity, TokenLoc}}.

-compile({inline, yyaction_2/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 12).
yyaction_2() ->
    skip_token.

-compile({inline, yyaction_3/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 13).
yyaction_3() ->
    skip_token.

-compile({inline, yyaction_4/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 14).
yyaction_4() ->
    skip_token.

-compile({inline, yyaction_5/3}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_14_2024.xrl", 15).
yyaction_5(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
