...
-module(lexer_day_17_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 21).
...
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.erl", 343).
yystate() -> 19.

yystate(20, [32 | Ics], Line, Col, Tlen, _, _) ->
    yystate(20, Ics, Line, Col, Tlen + 1, 3, Tlen);
yystate(20, [10 | Ics], Line, _, Tlen, _, _) ->
    yystate(20, Ics, Line + 1, 1, Tlen + 1, 3, Tlen);
yystate(20, Ics, Line, Col, Tlen, _, _) ->
    {3, Tlen, Ics, Line, Col, 20};
yystate(19, [82 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(19, [80 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(19, [58 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(19, [44 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(19, [32 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(19, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 67 ->
...
yystate(16, [C | Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Col, Tlen + 1, 6, Tlen);
yystate(16, Ics, Line, Col, Tlen, _, _) ->
    {6, Tlen, Ics, Line, Col, 16};
yystate(15, [103 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {2, Tlen, Ics, Line, Col};
yystate(11, [115 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(3, Ics, Line, Col, Tlen, _, _) ->
    {0, Tlen, Ics, Line, Col};
yystate(2, [103 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 11).
yyaction_0(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {register, TokenLoc}}.

-compile({inline, yyaction_1/2}).
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 12).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {program, TokenLoc}}.

-compile({inline, yyaction_2/3}).
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 13).
yyaction_2(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {label, TokenLoc, from_abc(TokenChars)}}.

-compile({inline, yyaction_3/0}).
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 14).
yyaction_3() ->
    skip_token.

-compile({inline, yyaction_4/0}).
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 15).
yyaction_4() ->
    skip_token.

-compile({inline, yyaction_5/0}).
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 16).
yyaction_5() ->
    skip_token.

-compile({inline, yyaction_6/3}).
-file("/home/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_17_2024.xrl", 17).
yyaction_6(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
