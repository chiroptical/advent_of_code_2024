...
-module(lexer_day_19_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_19_2024.xrl", 15).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_19_2024.erl", 345).
yystate() -> 3.

yystate(4, Ics, Line, Col, Tlen, _, _) ->
    {1, Tlen, Ics, Line, Col};
yystate(3, [119 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(3, [117 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(3, [114 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(3, [103 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(3, [98 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(3, [44 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(3, [32 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(2, [32 | Ics], Line, Col, Tlen, _, _) ->
    yystate(2, Ics, Line, Col, Tlen + 1, 3, Tlen);
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_19_2024.xrl", 8).
yyaction_0(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {color, TokenLoc, to_color(TokenChars)}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_19_2024.xrl", 9).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {newline, TokenLoc}}.

-compile({inline, yyaction_2/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_19_2024.xrl", 10).
yyaction_2(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {comma, TokenLoc}}.

-compile({inline, yyaction_3/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_19_2024.xrl", 11).
yyaction_3() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
