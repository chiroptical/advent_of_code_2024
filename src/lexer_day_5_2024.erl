...
-module(lexer_day_5_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_5_2024.xrl", 15).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_5_2024.erl", 339).
yystate() -> 3.

yystate(4, Ics, Line, Col, Tlen, _, _) ->
    {3, Tlen, Ics, Line, Col};
yystate(3, [124 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_5_2024.xrl", 8).
yyaction_0(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {number, TokenLoc, list_to_integer(TokenChars)}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_5_2024.xrl", 9).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {pipe, TokenLoc}}.

-compile({inline, yyaction_2/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_5_2024.xrl", 10).
yyaction_2(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {comma, TokenLoc}}.

-compile({inline, yyaction_3/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_5_2024.xrl", 11).
yyaction_3(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
