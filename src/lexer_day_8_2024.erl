...
-module(lexer_day_8_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_8_2024.xrl", 13).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_8_2024.erl", 339).
yystate() -> 2.
...
yystate(2, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 122 ->
    yystate(0, Ics, Line, Col, Tlen + 1, Action, Alen);
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_8_2024.xrl", 7).
yyaction_0(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {antenna, TokenLoc, TokenChars}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_8_2024.xrl", 8).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {blank, TokenLoc}}.

-compile({inline, yyaction_2/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_8_2024.xrl", 9).
yyaction_2() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
