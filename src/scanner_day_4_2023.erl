...
-module(scanner_day_4_2023).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.xrl", 14).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.erl", 339).
yystate() -> 7.
...
yystate(8, [10 | Ics], Line, _, Tlen, _, _) ->
    yystate(8, Ics, Line + 1, 1, Tlen + 1, 4, Tlen);
yystate(8, Ics, Line, Col, Tlen, _, _) ->
    {4, Tlen, Ics, Line, Col, 8};
yystate(7, [124 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(7, [67 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(6, [C | Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(6, Ics, Line, Col, Tlen + 1, 1, Tlen);
...
yystate(4, Ics, Line, Col, Tlen, _, _) ->
    {2, Tlen, Ics, Line, Col};
yystate(3, [97 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(0, [100 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.xrl", 6).
yyaction_0(TokenLine) ->
    {token, {card, TokenLine}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.xrl", 7).
yyaction_1(TokenChars, TokenLine) ->
    {token, {int, TokenLine, list_to_integer(TokenChars)}}.

-compile({inline, yyaction_2/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.xrl", 8).
yyaction_2(TokenLine) ->
    {token, {card_separator, TokenLine}}.

-compile({inline, yyaction_3/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.xrl", 9).
yyaction_3(TokenLine) ->
    {token, {number_separator, TokenLine}}.

-compile({inline, yyaction_4/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_4_2023.xrl", 10).
yyaction_4() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
