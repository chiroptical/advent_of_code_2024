...
-module(lexer_day_11_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_11_2024.xrl", 11).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_11_2024.erl", 339).
yystate() -> 1.
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_11_2024.xrl", 6).
yyaction_0(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {stone, TokenLoc, list_to_integer(TokenChars)}}.

-compile({inline, yyaction_1/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_11_2024.xrl", 7).
yyaction_1() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
