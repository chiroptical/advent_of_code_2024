...
-module(lexer_day_13_2024).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 25).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.erl", 344).
yystate() -> 17.

yystate(18, [32 | Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen + 1, 7, Tlen);
yystate(18, [10 | Ics], Line, _, Tlen, _, _) ->
    yystate(18, Ics, Line + 1, 1, Tlen + 1, 7, Tlen);
yystate(18, Ics, Line, Col, Tlen, _, _) ->
    {7, Tlen, Ics, Line, Col, 18};
yystate(17, [88 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [89 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [80 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [66 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [65 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [61 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [58 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(10, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(17, [44 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(17, [10 | Ics], Line, _, Tlen, Action, Alen) ->
    yystate(18, Ics, Line + 1, 1, Tlen + 1, Action, Alen);
...
yystate(16, Ics, Line, Col, Tlen, _, _) ->
    {3, Tlen, Ics, Line, Col};
yystate(15, [114 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(14, Ics, Line, Col, Tlen, _, _) ->
    {5, Tlen, Ics, Line, Col};
yystate(13, [105 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(12, [C | Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(12, Ics, Line, Col, Tlen + 1, 8, Tlen);
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {8, Tlen, Ics, Line, Col, 12};
yystate(11, [122 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(2, [110 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(0, [111 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 13).
yyaction_0(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {button, TokenLoc}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 14).
yyaction_1(TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {prize, TokenLoc}}.

-compile({inline, yyaction_2/3}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 15).
yyaction_2(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {to_atom(TokenChars), TokenLoc}}.

-compile({inline, yyaction_3/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 16).
yyaction_3() ->
    skip_token.

-compile({inline, yyaction_4/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 17).
yyaction_4() ->
    skip_token.

-compile({inline, yyaction_5/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 18).
yyaction_5() ->
    skip_token.

-compile({inline, yyaction_6/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 19).
yyaction_6() ->
    skip_token.

-compile({inline, yyaction_7/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 20).
yyaction_7() ->
    skip_token.

-compile({inline, yyaction_8/3}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/lexer_day_13_2024.xrl", 21).
yyaction_8(TokenChars, TokenLine, TokenCol) ->
    TokenLoc = {TokenLine, TokenCol},
    {token, {number, TokenLoc, list_to_integer(TokenChars)}}.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
    344
).
