...
-module(scanner_day_1_2023).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 34).
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.erl", 339).
yystate() -> 34.

yystate(35, [10 | Ics], Line, _, Tlen, _, _) ->
    yystate(35, Ics, Line + 1, 1, Tlen + 1, 0, Tlen);
yystate(35, Ics, Line, Col, Tlen, _, _) ->
    {0, Tlen, Ics, Line, Col, 35};
yystate(34, [116 | Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(32, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(34, [115 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(34, [102 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(34, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 49, C =< 57 ->
    yystate(33, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(34, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 100 ->
    yystate(31, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(34, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 103, C =< 109 ->
    yystate(31, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(34, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 112, C =< 114 ->
    yystate(31, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(34, [C | Ics], Line, Col, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(31, Ics, Line, Col, Tlen + 1, Action, Alen);
yystate(34, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action, Alen, Tlen, Ics, Line, Col, 34};
yystate(33, Ics, Line, Col, Tlen, _, _) ->
    {1, Tlen, Ics, Line, Col};
yystate(32, [119 | Ics], Line, Col, Tlen, _, _) ->
...
yystate(32, Ics, Line, Col, Tlen, _, _) ->
    {11, Tlen, Ics, Line, Col, 32};
yystate(31, Ics, Line, Col, Tlen, _, _) ->
    {11, Tlen, Ics, Line, Col};
yystate(30, [111 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(28, Ics, Line, Col, Tlen, _, _) ->
    {3, Tlen, Ics, Line, Col};
yystate(27, [116 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(18, [101 | Ics], Line, Col, Tlen, _, _) ->
    yystate(12, Ics, Line, Col, Tlen + 1, 11, Tlen);
yystate(18, Ics, Line, Col, Tlen, _, _) ->
    {11, Tlen, Ics, Line, Col, 18};
yystate(17, [120 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(9, [105 | Ics], Line, Col, Tlen, _, _) ->
    yystate(17, Ics, Line, Col, Tlen + 1, 11, Tlen);
yystate(9, Ics, Line, Col, Tlen, _, _) ->
    {11, Tlen, Ics, Line, Col, 9};
yystate(8, [110 | Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(6, Ics, Line, Col, Tlen, _, _) ->
    {8, Tlen, Ics, Line, Col};
yystate(5, [101 | Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 16).
yyaction_0(TokenLine) ->
    {token, {calibration_separator, TokenLine}}.

-compile({inline, yyaction_1/2}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 17).
yyaction_1(TokenChars, TokenLine) ->
    {token, {number, TokenLine, list_to_integer(TokenChars)}}.

-compile({inline, yyaction_2/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 19).
yyaction_2(TokenLine) ->
    {token, {number, TokenLine, 1}, "e"}.

-compile({inline, yyaction_3/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 20).
yyaction_3(TokenLine) ->
    {token, {number, TokenLine, 2}, "o"}.

-compile({inline, yyaction_4/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 21).
yyaction_4(TokenLine) ->
    {token, {number, TokenLine, 3}, "e"}.

-compile({inline, yyaction_5/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 22).
yyaction_5(TokenLine) ->
    {token, {number, TokenLine, 4}, "r"}.

-compile({inline, yyaction_6/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 23).
yyaction_6(TokenLine) ->
    {token, {number, TokenLine, 5}, "e"}.

-compile({inline, yyaction_7/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 24).
yyaction_7(TokenLine) ->
    {token, {number, TokenLine, 6}, "x"}.

-compile({inline, yyaction_8/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 25).
yyaction_8(TokenLine) ->
    {token, {number, TokenLine, 7}, "n"}.

-compile({inline, yyaction_9/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 26).
yyaction_9(TokenLine) ->
    {token, {number, TokenLine, 8}, "t"}.

-compile({inline, yyaction_10/1}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 27).
yyaction_10(TokenLine) ->
    {token, {number, TokenLine, 9}, "e"}.

-compile({inline, yyaction_11/0}).
-file("/Users/chiroptical/programming/erlang/advent_of_code_2024/src/scanner_day_1_2023.xrl", 29).
yyaction_11() ->
    skip_token.
-file(
    "/nix/store/5pjd6c7jnc7dzb4mjbjq1028s806yvhf-erlang-27.1.2/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl",
